...
const { login, register, reclamarCodigo, obtenerHistorial, loginAdmin, registerAdmin,obtenerGanadores  } =require('./controllers/promoControllers'); // Importa tanto login como register
